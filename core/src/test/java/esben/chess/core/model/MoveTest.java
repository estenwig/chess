...
public class MoveTest {
    ...
    @Test
    public void shouldHandleFourArgs() throws Exception {
        Square a1 = Square.getSquareFor("a1");
        Square a2 = Square.getSquareFor("a2");
        Square a3 = Square.getSquareFor("a3");
        Square b3 = Square.getSquareFor("b3");
        Move move = Move.createMove(a1, a2, a3, b3);
        assertThat(move.getFrom(), is(a1));
        assertThat(move.getTo(), is(b3));

        List<Square> allSquares = move.allSquares();
        List<Square> intermediateSquares = move.intermediateSquares();

        assertThat(allSquares.size(), is(4));
        assertThat(intermediateSquares.size(), is(2));
        assertThat(intermediateSquares, hasItems(a2,a3));
    }
}
